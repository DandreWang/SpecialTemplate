...
// const distFolder = env_conf === 'prod' ? 'app' : 'qhh5'
...
module.exports = {
  ...
  build: {
    ...
    index: path.resolve(__dirname, `../${distFolder}/${project}/index.html`),

    // Paths
    assetsRoot: path.resolve(__dirname, `../${distFolder}/${project}`),
    assetsSubDirectory: 'source',
