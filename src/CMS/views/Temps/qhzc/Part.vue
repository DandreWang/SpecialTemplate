<template>
  <section class="part">
    <el-form-item label="区块标题：">
      <el-input v-model="title" size="small" placeholder="请输入区块标题" class="selectBox"/>
    </el-form-item>
    ...
    <div class="">
      ...
      <el-button type="primary" size="mini" @click="handleAdd(2)">新增文字</el-button>
